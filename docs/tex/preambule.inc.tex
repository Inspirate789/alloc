...
\newcolumntype{I}{>{\centering\arraybackslash}p{0.18\textwidth}}
\newcolumntype{J}{>{\raggedleft\arraybackslash}p{0.18\textwidth}}

\newcolumntype{G}{>{\centering\arraybackslash}p{0.36\textwidth}}
\newcolumntype{K}{>{\raggedleft\arraybackslash}p{0.36\textwidth}}

\newcolumntype{V}{>{\centering\arraybackslash}p{14mm}}
\newcolumntype{W}{>{\centering\arraybackslash}p{14mm}}
\newcolumntype{X}{>{\centering\arraybackslash}p{20mm}}
\newcolumntype{Y}{>{\centering\arraybackslash}p{5mm}}
\newcolumntype{Z}{>{\centering\arraybackslash}p{5mm}}
