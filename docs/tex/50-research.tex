...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{График зависимости времени выполнения алгоритма конвейерной обработки данных от числа заявок}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{График зависимости времени выполнения алгоритма сортировки слиянием от числа элементов в массиве}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{График зависимости времени выполнения алгоритма нахождения расстояния Левенштейна от числа символов в строках}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{График зависимости времени выполнения алгоритма умножения матриц по Винограду от их размерности}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{График зависимости времени выполнения алгоритма сортировки подсчётом от числа элементов в массиве}
